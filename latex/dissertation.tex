...
A downside to AWS is that they do not allow for custom \gls{kernels} to be used and virtualised, leaving users to rely on the predefined images provided by the platform.
