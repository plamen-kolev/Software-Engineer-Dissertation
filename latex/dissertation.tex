...
The most important feature of virtualisation that enables its cloud capabilities is the level of abstraction it provides. The key feature is the ability to hide the underlying hardware architecture \cite{heterogenious-cloud-computing}[p.59]. The article Heterogeneous ... 
