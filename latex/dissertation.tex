...
\begin{figure}[H]
	\vspace{0.5cm}
	\includegraphics[width=10cm]{build_form}
	\vspace{0.5cm}
...
The decision to give preconfigured authentication credentials is because of the target demographic. Potential early adopters of the platform will have little to no experience in the field and would appreciate the convenience of things "just working".
