...
Furthermore, the \texttt{Nagios} software can be installed on each instance for even richer status information. Nagios is the industry standard in \gls{IT} infrastructure monitoring \cite{nagios-website}.
